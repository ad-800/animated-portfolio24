export const items = [
  {
    ...
    image: 'https://images.pexels.com/photos/929280/pexels-photo-929280.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
  ...
  },
  {
    ...
    image: '',
    description: 'Interactive technical visualizer using react-flow for the diagram and elk.js for automatic node positioning. Made for visualizing the flow of traffic from a client through a Envoy proxy to clusters as well as illustrating the health impact of a down server on the system. Users can hover over a edge to highlight connected nodes.',
  },
  {
